  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AirQualityRawSchema>
    ...
    public AirQualityRawSchema build() {
      try {
        ...
        record.co = fieldSetFlags()[4] ? this.co : (java.lang.Double) defaultValue(fields()[4]);
        record.no = fieldSetFlags()[5] ? this.no : (java.lang.Double) defaultValue(fields()[5]);
        record.no2 = fieldSetFlags()[6] ? this.no2 : (java.lang.Double) defaultValue(fields()[6]);
        record.o3 = fieldSetFlags()[7] ? this.o3 : (java.lang.Double) defaultValue(fields()[7]);
        record.so2 = fieldSetFlags()[8] ? this.so2 : (java.lang.Double) defaultValue(fields()[8]);
        record.pm25 = fieldSetFlags()[9] ? this.pm25 : (java.lang.Double) defaultValue(fields()[9]);
        record.pm10 = fieldSetFlags()[10] ? this.pm10 : (java.lang.Double) defaultValue(fields()[10]);
        record.pm1 = fieldSetFlags()[11] ? this.pm1 : (java.lang.Double) defaultValue(fields()[11]);
