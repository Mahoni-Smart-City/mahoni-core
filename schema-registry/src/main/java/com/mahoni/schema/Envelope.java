...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1832134590009179190L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"com.mahoni.schema\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name_location\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"id_location\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"postgres.public.air_sensors.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.postgresql\",\"fields\":[{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"connector\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"ts_ms\",\"type\":\"long\"},{\"name\":\"snapshot\",\"type\":[{\"type\":\"string\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"true,last,false,incremental\"},\"connect.default\":\"false\",\"connect.name\":\"io.debezium.data.Enum\"},\"null\"],\"default\":\"false\"},{\"name\":\"db\",\"type\":\"string\"},{\"name\":\"sequence\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"schema\",\"type\":\"string\"},{\"name\":\"table\",\"type\":\"string\"},{\"name\":\"txId\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"lsn\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"xmin\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.postgresql.Source\"}},{\"name\":\"op\",\"type\":\"string\"},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"transaction\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"ConnectDefault\",\"namespace\":\"io.confluent.connect.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"total_order\",\"type\":\"long\"},{\"name\":\"data_collection_order\",\"type\":\"long\"}]}],\"default\":null}],\"connect.name\":\"postgres.public.air_sensors.Envelope\"}");
  ...
  public static Envelope fromByteBuffer(
   ...
   private com.mahoni.schema.Value before;
   private com.mahoni.schema.Value after;
   ...
   */
  public Envelope(com.mahoni.schema.Value before, com.mahoni.schema.Value after, io.debezium.connector.postgresql.Source source, CharSequence op, Long ts_ms, io.confluent.connect.avro.ConnectDefault transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: before = (com.mahoni.schema.Value)value$; break;
    case 1: after = (com.mahoni.schema.Value)value$; break;
    case 2: source = (io.debezium.connector.postgresql.Source)value$; break;
    case 3: op = (CharSequence)value$; break;
    case 4: ts_ms = (Long)value$; break;
   ...
   */
  public com.mahoni.schema.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(com.mahoni.schema.Value value) {
    this.before = value;
  }
   ...
   */
  public com.mahoni.schema.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(com.mahoni.schema.Value value) {
    this.after = value;
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static Builder newBuilder(Envelope other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private com.mahoni.schema.Value before;
    private com.mahoni.schema.Value.Builder beforeBuilder;
    private com.mahoni.schema.Value after;
    private com.mahoni.schema.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
    ...
    private Builder(Builder other) {
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = com.mahoni.schema.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = com.mahoni.schema.Value.newBuilder(other.getAfterBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBefore(com.mahoni.schema.Value value) {
     ...
     * @return This builder.
     */
    public com.mahoni.schema.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(com.mahoni.schema.Value.newBuilder(before));
        } else {
          setBeforeBuilder(com.mahoni.schema.Value.newBuilder());
        }
      }
    ...
    public Builder setBeforeBuilder(com.mahoni.schema.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAfter(com.mahoni.schema.Value value) {
     ...
     * @return This builder.
     */
    public com.mahoni.schema.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(com.mahoni.schema.Value.newBuilder(after));
        } else {
          setAfterBuilder(com.mahoni.schema.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public Builder setAfterBuilder(com.mahoni.schema.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTransaction(io.confluent.connect.avro.ConnectDefault value) {
    ...
    public Builder setTransactionBuilder(io.confluent.connect.avro.ConnectDefault.Builder value) {
      clearTransaction();
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (com.mahoni.schema.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (com.mahoni.schema.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
        ...
        record.op = fieldSetFlags()[3] ? this.op : (CharSequence) defaultValue(fields()[3]);
        record.ts_ms = fieldSetFlags()[4] ? this.ts_ms : (Long) defaultValue(fields()[4]);
        if (transactionBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new com.mahoni.schema.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new com.mahoni.schema.Value();
        }
