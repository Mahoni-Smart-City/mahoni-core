...
public class ConnectDefault extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ConnectDefault(CharSequence id, Long total_order, Long data_collection_order) {
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: total_order = (Long)value$; break;
    case 2: data_collection_order = (Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new ConnectDefault RecordBuilder
   */
  public static Builder newBuilder(ConnectDefault other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConnectDefault>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ConnectDefault other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    public ConnectDefault build() {
      try {
        ...
        record.total_order = fieldSetFlags()[1] ? this.total_order : (Long) defaultValue(fields()[1]);
        record.data_collection_order = fieldSetFlags()[2] ? this.data_collection_order : (Long) defaultValue(fields()[2]);
        return record;
